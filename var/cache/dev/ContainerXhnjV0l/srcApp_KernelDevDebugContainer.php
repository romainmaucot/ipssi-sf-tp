...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('lMVN8VIn2t', 0, ($this->targetDirs[0].'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('o7XidJgt3D', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $a = new \Symfony\Bundle\TwigBundle\Loader\NativeFilesystemLoader([], '/srv');
        $a->addPath('/srv/vendor/symfony/framework-bundle/Resources/views', 'Framework');
        $a->addPath('/srv/vendor/symfony/framework-bundle/Resources/views', '!Framework');
        $a->addPath('/srv/vendor/symfony/twig-bundle/Resources/views', 'Twig');
        $a->addPath('/srv/vendor/symfony/twig-bundle/Resources/views', '!Twig');
        $a->addPath('/srv/vendor/doctrine/doctrine-bundle/Resources/views', 'Doctrine');
        $a->addPath('/srv/vendor/doctrine/doctrine-bundle/Resources/views', '!Doctrine');
        $a->addPath('/srv/vendor/symfony/web-profiler-bundle/Resources/views', 'WebProfiler');
        $a->addPath('/srv/vendor/symfony/web-profiler-bundle/Resources/views', '!WebProfiler');
        $a->addPath('/srv/vendor/symfony/debug-bundle/Resources/views', 'Debug');
        $a->addPath('/srv/vendor/symfony/debug-bundle/Resources/views', '!Debug');
        $a->addPath('/srv/templates');
        $a->addPath('/srv/vendor/symfony/twig-bridge/Resources/views/Form');

        $this->services['twig'] = $instance = new \Twig\Environment($a, ['default_path' => '/srv/templates', 'debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception::showAction', 'form_themes' => $this->parameters['twig.form.resources'], 'autoescape' => 'name', 'cache' => ($this->targetDirs[0].'/twig'), 'charset' => 'UTF-8', 'paths' => [], 'date' => ['format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL], 'number_format' => ['decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',']]);
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension($c, '/srv', 'UTF-8'));
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fjVNV4kIMM', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('OcXjyNUx-9', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
