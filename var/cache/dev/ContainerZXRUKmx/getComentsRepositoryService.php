...
// Returns the private 'App\Repository\ComentsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ComentsRepository.php';

return $this->privates['App\Repository\ComentsRepository'] = new \App\Repository\ComentsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
