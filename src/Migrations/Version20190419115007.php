 ...
 */
final class Version20190419115007 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article ADD censored TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article DROP censored');
        $this->addSql('ALTER TABLE comment CHANGE article_id article_id INT DEFAULT NULL');
