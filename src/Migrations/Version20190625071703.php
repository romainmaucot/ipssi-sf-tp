 ...
 */
final class Version20190625071703 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment CHANGE conference_id conference_id INT DEFAULT NULL, CHANGE ref_note_id_id ref_note_id_id INT DEFAULT NULL');
    }
